...
<body>
    <section class="hero">
        ...
        <h1 class="animate__animated animate__fadeInDown">Sistem Pendidikan</h1>
        ...
        <div class="menu-items animate__animated animate__fadeInUp">
            <a href="{{ route('login') }}" class="menu-item">
                ...
                <div class="menu-text">Data Pegawai Tugas Belajar</div>
            </a>
            
            <a href="{{ route('login') }}" class="menu-item">
                <div class="menu-icon"><i class="fas fa-briefcase"></i></div>
                <div class="menu-text">Data Praktik Klinik/ Magang</div>
            </a>
            
            <a href="{{ route('tata-tertib') }}" class="menu-item">
                <div class="menu-icon"><i class="fas fa-clipboard-list"></i></div>
                <div class="menu-text">Tata Tertib Peserta Praktik/ Magang</div>
            </a>
            
            <a href="{{ route('hak-kewajiban') }}" class="menu-item">
                <div class="menu-icon"><i class="fas fa-balance-scale"></i></div>
                <div class="menu-text">Hak dan Kewajiban Peserta Praktik/ Magang</div>
            </a>
            
            <a href="{{ route('login') }}" class="menu-item">
                <div class="menu-icon"><i class="fas fa-chart-line"></i></div>
                <div class="menu-text">Evaluasi Peserta Praktik/ Magang</div>
            </a>
            
            <a href="{{ route('preceptor') }}" class="menu-item">
                <div class="menu-icon"><i class="fas fa-chalkboard-teacher"></i></div>
                <div class="menu-text">Preceptor Klinik</div>
            </a>
        </div>
    </section>
